package br.com.alura.screemmatach.repository;

import br.com.alura.screemmatach.model.Categoria;
...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    List<Episodios> episodioPorSerieAno(Serie serie, int anoLancamento);
}
